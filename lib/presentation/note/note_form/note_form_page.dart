...
import 'package:firebasedddresocoder/presentation/note/note_form/widgets/add_todo_tile_widget.dart';
import 'package:firebasedddresocoder/presentation/note/note_form/widgets/body_field_widget.dart';
import 'package:firebasedddresocoder/presentation/note/note_form/widgets/color_field_widget.dart';
import 'package:firebasedddresocoder/presentation/note/note_form/widgets/todo_list_widget.dart';
    ...
    return BlocProvider(
      ...
      child: BlocConsumer<NoteFormBloc, NoteFormState>(
        ...
        builder: (context, state) {
          return Stack(
            children: <Widget>[const NoteFormPageScaffold(), SavingInProgressOverlay(isSaving: state.isSaving)],
          );
        },
      ),
    );
