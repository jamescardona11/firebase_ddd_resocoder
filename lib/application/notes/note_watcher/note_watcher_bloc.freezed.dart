...
// ignore: unused_element
  _WatchallUncompletedStarted watchUncompletedStarted() {
    return const _WatchallUncompletedStarted();
  }
...
mixin _$NoteWatcherEvent {
  ...
  Result map<Result extends Object>({
    ...
    @required Result watchUncompletedStarted(_WatchallUncompletedStarted value),
    @required Result notesReceived(_NotesReceived value),
  });
  @optionalTypeArgs
  Result maybeMap<Result extends Object>({
    Result watchAllStarted(_WatchallStarted value),
    Result watchUncompletedStarted(_WatchallUncompletedStarted value),
...
abstract class _$WatchallUncompletedStartedCopyWith<$Res> {
  factory _$WatchallUncompletedStartedCopyWith(
          _WatchallUncompletedStarted value,
          $Res Function(_WatchallUncompletedStarted) then) =
      __$WatchallUncompletedStartedCopyWithImpl<$Res>;
}

class __$WatchallUncompletedStartedCopyWithImpl<$Res>
    extends _$NoteWatcherEventCopyWithImpl<$Res>
    implements _$WatchallUncompletedStartedCopyWith<$Res> {
  __$WatchallUncompletedStartedCopyWithImpl(_WatchallUncompletedStarted _value,
      $Res Function(_WatchallUncompletedStarted) _then)
      : super(_value, (v) => _then(v as _WatchallUncompletedStarted));

  @override
  _WatchallUncompletedStarted get _value =>
      super._value as _WatchallUncompletedStarted;
}

class _$_WatchallUncompletedStarted implements _WatchallUncompletedStarted {
  const _$_WatchallUncompletedStarted();
  ...
  @override
  bool operator ==(dynamic other) {
    return identical(this, other) || (other is _WatchallUncompletedStarted);
  }
...
abstract class _WatchallUncompletedStarted implements NoteWatcherEvent {
  const factory _WatchallUncompletedStarted() = _$_WatchallUncompletedStarted;
}
